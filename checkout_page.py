...
class CheckoutPage(BasePage):
    ...
    FIRST_NAME_SELECTOR = '.checkout_info_wrapper >> input[name="firstName"]'
    LAST_NAME_SELECTOR = '.checkout_info_wrapper >> input[name="lastName"]'
    POSTAL_CODE_SELECTOR = '.checkout_info_wrapper >> input[name="postalCode"]'
    BUTTON_CONTINUE = '.checkout_info_wrapper >> input[name="continue"]'
